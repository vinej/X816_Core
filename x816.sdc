...
#   outclk_1  general[1]   12.5 MHz  aud_mclk   (spare)
#   outclk_2  general[2]    8.0 MHz  cpu_clk    (CPU, VIA, SMC)
...
# this the 8 MHz domain shows large negative slack on phantom cross paths.
# ============================================================================
